...
export default async function EditDetailsPage({ params }) {
    ...
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      ...
      <div style={{ backgroundColor: 'white', borderRadius: '12px', boxShadow: '0 1px 3px rgba(0,0,0,0.05)', overflow: 'hidden' }}>
        ...
        <div style={{ padding: '32px' }}>
          ...
          <DetailsForm productId={id} details={details || {}} />
        </div>
      </div>
    </div>
  );
...
function Tabs({ productId }) {
  const tabs = [
    ...
    { label: 'Details', href: `/admin/products/${productId}/edit/details`, active: true },
    { label: 'Pricing', href: `/admin/products/${productId}/edit/pricing` },
    { label: 'Inventory', href: `/admin/products/${productId}/edit/inventory` },
